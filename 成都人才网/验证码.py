...
response = requests.get('https://member.rc114.com/Home/GetValidcode', cookies=cookies, headers=headers)
base64_url = response.text.split('"ValidImage":"')[1].split('"}')[0]
with open('验证码.png', 'wb') as f:
    f.write(base64.b64decode(base64_url))